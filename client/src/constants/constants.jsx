...
export const pfp = "https://ssl.gstatic.com/ui/v1/icons/mail/profile_mask2.png"
...
export const EMPTY_TABS = {
    ...
    allmail : {
        heading : "No Mails in your Gmail Clone Right Now",
        subHeading : "Click on compose and send mail to see the results"
    }
}