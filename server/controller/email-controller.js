...
export const saveSentEmails =  (request,response) => {
    try{
        ...
        response.status(200).json("Email is saved succesfully");
    }
    catch(error){
...
export const moveEmailsToBin = async (request,response) => {
    try
    {
        ...
        return response.status(200).json('emails deleted succefully')
    }
    catch(error)
    {
        console.log(error);
...
export const deleteEmails = async (request,response) => {
    try{
        ...
        return response.status(200).json("Email gayi");
    }
    catch(error){
        console.log(error);
        response.status(500).json(error.message);   
